...
import { fetchUsers } from "@/services/api_test";
...
const Employers: React.FC = () => {
  ...
  const approvedUsers = employees.filter((user) => user.is_verified);
  const pendingUsers = employees.filter((user) => !user.is_verified);
