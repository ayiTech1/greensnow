...
const JobCard: React.FC<JobCardProps> = ({
  ...
  return (
    <View
      style={tw`flex flex-col w-full text-sm font-semibold tracking-tight mt-3 leading-6 text-center text-white rounded-none max-w-[362px] h-[211px]`}
    >
      <View
        style={tw`flex flex-col justify-center px-2 py-2 w-full bg-white rounded-xl shadow-[0px_2px_4px_rgba(0,0,0,0.25)] w-full h-[211px] shadow-lg`}
      >
        <View
